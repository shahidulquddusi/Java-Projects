...
public class Input {
    /**
     * A simple method that validates and then accepts integer as input with recursive request.
     * The method uses {@code Scanner} to receive input.
     * <br><br>The string param, <span style="color: #6198d4;">{@code name}</span>, is to facilitate the prompt.
     *
     * @param name
